...
public class PlayerInfoResponse {
	...
	List<AchievementResponse> AchievementLists;
	...
	public List<AchievementResponse> getAchievementLists() {
		return AchievementLists;
	}

	public void setAchievementLists(List<AchievementResponse> achievementLists) {
		AchievementLists = achievementLists;
	}
